...
const Home = () => {
  ...
  return (
    <div className="flex bg-gray-50 md:flex-row flex-col h-screen duration-75 ease-out">
      <div
        className="hidden md:flex h-scree
       flex-initial"
      >
      ...
      {toggleSidebar && (
        <div className="fixed w-4/5 bg-white h-screen overflow-y-auto shadow-md z-10 animate-slide-id">
          <div
      ...
      <div
        className="pb-2 flex-1 h-screen overflow-y-sc
      "
        ref={scrollRef}
      >
        <Routes>
